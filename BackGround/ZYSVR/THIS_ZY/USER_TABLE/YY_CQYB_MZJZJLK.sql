--医保门诊登记信息(日表)
if not exists(select 1 from sysobjects where name='YY_CQYB_MZJZJLK')
begin  
	create table YY_CQYB_MZJZJLK
	(      
	...
	create index idx_jssjh on YY_CQYB_MZJZJLK(jssjh)	
	create index idx_sbkh on YY_CQYB_MZJZJLK(sbkh)	
end
go
